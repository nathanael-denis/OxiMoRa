...
# Add a frame line around the matrix
ax.hlines(y=-0.5, xmin=-0.5, xmax=3.5, color='black', linewidth=2)
ax.hlines(y=3.5, xmin=-0.5, xmax=3.5, color='black', linewidth=2)
ax.vlines(x=-0.5, ymin=-0.5, ymax=3.5, color='black', linewidth=2)
ax.vlines(x=3.5, ymin=-0.5, ymax=3.5, color='black', linewidth=2)
